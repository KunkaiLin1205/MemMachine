...
TaskFactsSemanticCategory = SemanticCategory(
    name="profile",
    prompt=StructuredSemanticPrompt(
        tags=task_facts_tags,
        description=task_facts_description,
    ),
)

SEMANTIC_TYPE = TaskFactsSemanticCategory
